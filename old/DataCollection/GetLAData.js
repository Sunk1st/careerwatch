...
exports.getLAData = function (salaryString, jobString, file) {
  let urlJob = 'https://www.indeed.com/jobs?q=' + jobString + '&l=Los+Angeles,+CA&jt=fulltime'
  let urlSalary = 'https://www.indeed.com/salaries/' + salaryString + '-Salaries,-Los-Angeles-CA'
  ...
  rp(salaries).then(($) => { 
    ...
    rp(jobs).then(($) => {
        ...
        let sendData = 'LA, ' + finalResult + ',' + samples + ',' + totalJobs + ',' + city.sizeRank.LA + '\n'
